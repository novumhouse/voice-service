...
class VoiceController {
    ...
    async startConversation(req, res) {
        try {
            ...
            const { agentId, conversationId, clientType = 'web', metadata } = req.body;
     ...
     */
    async getUserVoiceUsage(req, res) {
        try {
            const user = req.user;
     ...
     */
    async decryptUserContext(req, res) {
        try {
     ...
     */
    async makeAuthenticatedCall(req, res) {
        try {
            const { conversationId } = req.params;
